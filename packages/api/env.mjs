...
export const env = createEnv({
  server: {
    ...
    WEB_GITHUB_CLIENT_ID: z.string().min(1),
    WEB_GITHUB_CLIENT_SECRET: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    WEB_GITHUB_CLIENT_ID: process.env.WEB_GITHUB_CLIENT_ID,
    WEB_GITHUB_CLIENT_SECRET: process.env.WEB_GITHUB_CLIENT_SECRET,
  },
